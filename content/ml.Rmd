...
[1. What is machine learning and why would you use it?](#what) 

[2. Examples of the most popular machine learning examples in Python and R](#examples) 
...
## 2. Examples of the most popular machine learning algorithms in Python and R {#examples}
...
* Python API to [tensorflow](https://tomis9.github.io/tensorflow). `tensorflow` was used in very few cases, because it is designed mainly for neural networks, and we would have to implement the algorithms from scratch.

Let's prepare data for our algorithms. You can read more about data preparation in [this blog post](https://tomis9.github.io/useful_processing).
