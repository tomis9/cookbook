...
## 1. What is data.table and why would you use it? {#what}

* data.table is an R packge which let's you work on tabular datasets quickly and easily;

* comparing to base R or [dplyr](https://tomis9.github.io/tidyverse/#/dplyr) it's significantly faster;

* data.table has a concise and SQL-like syntax.

## 2. Basic functionalities {#basic}

### Creating a data.table {#creating}
...
### Creating a new column {#newcolumn}
...
## 3. Subjects still to cover: {#todo}
