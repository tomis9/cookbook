...
## 1. What is tidyverse and why would you use it? {#what}
...
To be honest, I prefer [data.table](https://tomis9.github.io/data.table) to tidyverse, as it resembles basic R data.frames, is faster, more concise and, IMHO, more SQL-ish. But it takes longer to master and may be more difficult to understand, even your own code after some time. So, there is no obvious choice between data.table and dplyr.
