...
To be honest, I prefer [data.table](https://tomis9.github.io/post/data.table) to tidyverse, as it resembles basic R data.frames, is faster, more concise and, IMHO, more SQL-ish. But it takes longer to master and may be more difficult to understand, even your own code after some time. So, there is no obvious choice between data.table and dplyr.
...
I prepared a separate tutorial for [ggplot2](https://tomis9.github.io/ggplot2).
...
* dplyr: joins, slice, count, spread, separate/unite (TODO) (count is exactly the same as group_by + summarise, spread is dcast)
