...
## 1. What are decision trees and why would you use them? {#what}
...
* understanding decision trees is important if you want to learn [random forests](https://tomis9.github.io/random-forests).
...
## 3. Interesting links {#interesting}
