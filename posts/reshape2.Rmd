...
Keep in mind that if your favourite R package for dataframes manipulation is [data.table](https://tomis9.github.io/post/data.table), functions *dcast* and *melt* are already in this package and work exactly the same as those in `reshape2`.
